...
/**
 * @done Si el número de misiones del piloto es 0, no puede tener incidencias;
...
/**
 * @done Si el número de misiones del piloto es 0, no puede tener fecha de
 *       última misión; haz esta comprobación y lanza la excepción
 *       correspondiente
 */
Piloto& Piloto::setFechaUltimaMision ( long fechaUltimaMision )
{
    if(_numMisiones ==0 && _fechaUltimaMision !=0){
        throw std::invalid_argument ("No puede tener fecha de ultima mision si no ha realizado ninguna");
    }
